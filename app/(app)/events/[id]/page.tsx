    ...
    <div className="w-full min-h-screen bg-slate-50 dark:bg-slate-800">
      ...
      <div className="max-w-4xl px-6 py-8 mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="mb-4 text-4xl font-bold text-slate-900 dark:text-slate-200">
            {event.title}
          </h1>

          <div className="flex flex-wrap gap-6 mb-6 text-slate-600 dark:text-slate-200">
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <h4 className="mb-1 font-medium text-slate-900 dark:text-slate-200">
                    Date & Time
                  </h4>
