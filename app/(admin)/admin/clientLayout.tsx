...
const navigation = [
  ...
  { name: "Sectors", href: "/admin/sectors", icon: Layers },
  { name: "Companies", href: "/admin/companies", icon: Building2 },
  { name: "Investors", href: "/admin/investors", icon: Users },
  { name: "Funding Rounds", href: "/admin/rounds", icon: TrendingUp },
  { name: "Downloads", href: "/admin/downloads", icon: Download },

  { name: "Other Platforms", href: "/admin/other-platforms", icon: Share2 },
    ...
    <div>
      ...
      <div className="flex flex-1 ">
        <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
          <SheetContent side="left" className="p-0 sm:max-w-xs bg-primary">
        ...
        <aside className="fixed flex-col hidden w-64 h-full border-r bg-slate-800 lg:flex">
